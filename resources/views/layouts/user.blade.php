...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="{{ route('home') }}">
            <img src="{{ asset('images/galleryBS/Logo.jpg') }}">
        </a>
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="{{ route('transaksi.form') }}">Mitra</a></li>
                        <li><a class="dropdown-item" href="{{ route('mitra.create') }}">Non Mitra</a></li>
                    </ul>
                </li>
            </ul>
...
<footer class="footer bg-light mt-5">
    <div class="container py-4">
        <div class="row">
            <div class="col-md-4">
                <h5>Tentang Kami</h5>
                <img src="{{ asset('images/Logo_Bank_Sampah') }}" alt="Logo Bank Sampah" class="footer-logo">
                <p>Bank Sampah Mitra CSR Indocement berkomitmen untuk mendukung kelestarian lingkungan melalui program daur ulang sampah yang efektif dan berkelanjutan.</p>
            </div>
        <p>
